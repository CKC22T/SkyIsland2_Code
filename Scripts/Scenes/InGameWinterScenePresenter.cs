...
namespace Olympus
{
    public class InGameWinterScenePresenter : MonoBehaviour
    {
        public static InGameWinterScenePresenter Instance { get; private set; }
        ...
        private void Start()
        {
            ...
            GameDataManager.Instance.Initialize(IslandType.Winter);
            ...
            BGMController.Instance.ChangeBGM("BGM_Winter_Creta");
