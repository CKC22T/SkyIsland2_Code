...
namespace Olympus
{
    public class InGameSummerScenePresenter : MonoBehaviour
    {
        public static InGameSummerScenePresenter Instance { get; private set; }
        ...
        private void Start()
        {
            ...
            GameDataManager.Instance.Initialize(IslandType.Summer);
            ...
            BGMController.Instance.ChangeBGM("BGM_Summer_Io");
