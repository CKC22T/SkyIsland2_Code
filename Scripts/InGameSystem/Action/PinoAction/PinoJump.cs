...
namespace Olympus
{
    public class PinoJump : ActionBase
    {
        ...
        public override void Excute()
        {
            ...
            {
                ActionName = entity.Weapon.WeaponData.WeaponName + "Jump";
            }
            else
            {
                ActionName = "Jump";
        ...
        public override bool TryChangeActionType(ActionType changeActionType)
        {
            ...
            if (changeActionType == ActionType.Move ||
                ...
                changeActionType == ActionType.Jump)
            {
                return entity.IsGround && entity.physics.VerticalVelocity.y <= 0;
            }
